...
SET PFAD_PROJEKT_DATEI=LaserControl.sln

call %msbuild% %PFAD_PROJEKT_DATEI% /p:OutputDir=%PFAD_AUSGABE_ORDNER% /p:Configuration=Debug /p:Optimize=true /p:AllowUnsafeBlocks=true
